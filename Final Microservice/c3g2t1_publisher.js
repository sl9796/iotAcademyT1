...
var ads_client_1 = require("ads-client"); // Import ADS client library to connect to Beckhoff PLC
var mqtt_1 = require("mqtt"); // Import MQTT library to publish data to the MQTT broker
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                setInterval(function () { return __awaiter(void 0, void 0, void 0, function () {
                    var getLocalTimestamp, timestamp, _loop_1, _i, _a, tag, motorPositionData, _b, _c, tag, result, err_2, motorPositionPayload, motorTorqueData, _d, _e, tag, result, err_3, motorTorquePayload;
